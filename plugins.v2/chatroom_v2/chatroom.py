...
class Chatroom(_PluginBase):
    ...
    plugin_name = "聊天室增强版"
    # 插件描述
    plugin_desc = "一个简单的实时聊天室，支持表情和在线状态"
    # 插件图标
    ...
    # 插件配置项ID前缀
    plugin_config_prefix = "chatroom_v2_"
    # 加载顺序
    plugin_order = 1
    # 可使用的用户级别
    auth_level = 1
    ...
    def init_plugin(self, config: dict = None):
        ...
        """
        # 设置聊天数据保存路径
        self._chat_data_path = os.path.join(settings.CONFIG_PATH, 'chatroom_v2_data.json')
                ...
                "content": [
                    {
                        "component": "ChatRoom",
                        "props": {
                            "apiMessages": "/api/plugin/chatroom_v2/chat_v2/messages",
                            "apiSend": "/api/plugin/chatroom_v2/chat_v2/send",
                            "apiOnline": "/api/plugin/chatroom_v2/chat_v2/online",
                            "apiHeartbeat": "/api/plugin/chatroom_v2/chat_v2/heartbeat",
                            "apiClear": "/api/plugin/chatroom_v2/chat_v2/clear"
                        }
                    }
                ]
            }
